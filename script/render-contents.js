   ...
   <img src="images-and-icons/images/${personalData.photo}" alt="profile-pic" class="profile-pic">
    ...
    <nav class="socmed-nav">
      <ul>
        ...
        <li><a href="${personalData.youtubeLink}"><img src="images-and-icons/icons/youtube.png" alt="ytb-icon" class="socmed-icon"></a></li>
        <li><a href="${personalData.insLink}"><img src="images-and-icons/icons/instagram.png" alt="ins-icon" class="socmed-icon"></a></li>
        <li><a href="${personalData.tiktokLink}"><img src="images-and-icons/icons/tiktok.png" alt="tiktok-icon" class="socmed-icon"></a></li>
        <li><a href="${personalData.linkedinLink}"><img src="images-and-icons/icons/linkedin.png" alt="linkedin-icon" class="socmed-icon"></a></li>
      </ul>
    </nav>`;
